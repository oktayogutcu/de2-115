...
module nios2_freertos_mm_interconnect_0 (
	...
	wire  [103:0] debug_avalon_jtag_slave_agent_rf_source_data;                                       // debug_avalon_jtag_slave_agent:rf_source_data -> debug_avalon_jtag_slave_agent_rsp_fifo:in_data
	...
	wire  [103:0] debug_avalon_jtag_slave_agent_rsp_fifo_out_data;                                    // debug_avalon_jtag_slave_agent_rsp_fifo:out_data -> debug_avalon_jtag_slave_agent:rf_sink_data
	...
	wire  [102:0] cmd_mux_src_data;                                                                   // cmd_mux:src_data -> debug_avalon_jtag_slave_agent:cp_data
	...
	wire  [102:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> sdram_s1_agent:cp_data
	wire          cmd_mux_002_src_ready;                                                              // sdram_s1_agent:cp_ready -> cmd_mux_002:src_ready
	wire    [3:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> sdram_s1_agent:cp_channel
	...
	wire  [103:0] sys_clk_s1_agent_rf_source_data;                                                    // sys_clk_s1_agent:rf_source_data -> sys_clk_s1_agent_rsp_fifo:in_data
	...
	wire  [103:0] sys_clk_s1_agent_rsp_fifo_out_data;                                                 // sys_clk_s1_agent_rsp_fifo:out_data -> sys_clk_s1_agent:rf_sink_data
	...
	wire  [102:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> sys_clk_s1_agent:cp_data
	wire          cmd_mux_003_src_ready;                                                              // sys_clk_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire    [3:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> sys_clk_s1_agent:cp_channel
	...
	wire  [102:0] debug_avalon_jtag_slave_agent_rp_data;                                              // debug_avalon_jtag_slave_agent:rp_data -> router_002:sink_data
	...
	wire  [102:0] sdram_s1_agent_rp_data;                                                             // sdram_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [102:0] sys_clk_s1_agent_rp_data;                                                           // sys_clk_s1_agent:rp_data -> router_005:sink_data
