// nios2_freertos_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module nios2_freertos_mm_interconnect_0 (
	...
	wire   [28:0] debug_avalon_jtag_slave_agent_m0_address;                                           // debug_avalon_jtag_slave_agent:m0_address -> debug_avalon_jtag_slave_translator:uav_address
	...
	wire  [105:0] debug_avalon_jtag_slave_agent_rf_source_data;                                       // debug_avalon_jtag_slave_agent:rf_source_data -> debug_avalon_jtag_slave_agent_rsp_fifo:in_data
	...
	wire  [105:0] debug_avalon_jtag_slave_agent_rsp_fifo_out_data;                                    // debug_avalon_jtag_slave_agent_rsp_fifo:out_data -> debug_avalon_jtag_slave_agent:rf_sink_data
	...
	wire  [104:0] cmd_mux_src_data;                                                                   // cmd_mux:src_data -> debug_avalon_jtag_slave_agent:cp_data
	...
	wire   [28:0] sys_clk_s1_agent_m0_address;                                                        // sys_clk_s1_agent:m0_address -> sys_clk_s1_translator:uav_address
	...
	wire  [105:0] sys_clk_s1_agent_rf_source_data;                                                    // sys_clk_s1_agent:rf_source_data -> sys_clk_s1_agent_rsp_fifo:in_data
	...
	wire  [105:0] sys_clk_s1_agent_rsp_fifo_out_data;                                                 // sys_clk_s1_agent_rsp_fifo:out_data -> sys_clk_s1_agent:rf_sink_data
	...
	wire  [104:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> sys_clk_s1_agent:cp_data
	wire          cmd_mux_003_src_ready;                                                              // sys_clk_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire    [6:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> sys_clk_s1_agent:cp_channel
	...
	wire  [104:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> switch_s1_agent:cp_data
	...
	wire  [104:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> button_s1_agent:cp_data
	...
	wire  [104:0] debug_avalon_jtag_slave_agent_rp_data;                                              // debug_avalon_jtag_slave_agent:rp_data -> router_002:sink_data
	...
	wire  [104:0] sys_clk_s1_agent_rp_data;                                                           // sys_clk_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [104:0] switch_s1_agent_rp_data;                                                            // switch_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [104:0] button_s1_agent_rp_data;                                                            // button_s1_agent:rp_data -> router_008:sink_data
	...
	nios2_freertos_mm_interconnect_0_router router (
	...
	nios2_freertos_mm_interconnect_0_router_001 router_001 (
	...
	nios2_freertos_mm_interconnect_0_router_002 router_002 (
	...
	nios2_freertos_mm_interconnect_0_router_003 router_003 (
	...
	nios2_freertos_mm_interconnect_0_router_003 router_004 (
	...
	nios2_freertos_mm_interconnect_0_router_002 router_005 (
	...
	nios2_freertos_mm_interconnect_0_router_002 router_006 (
	...
	nios2_freertos_mm_interconnect_0_router_002 router_007 (
	...
	nios2_freertos_mm_interconnect_0_router_002 router_008 (
	...
	nios2_freertos_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clocks_sys_clk_clk),                             //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_freertos_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clocks_sys_clk_clk),                             //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_freertos_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clocks_sys_clk_clk),                             //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_freertos_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (clocks_sys_clk_clk),                             //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_freertos_mm_interconnect_0_cmd_mux_001 cmd_mux_002 (
		.clk                 (clocks_sys_clk_clk),                             //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_freertos_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clocks_sys_clk_clk),                             //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_freertos_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clocks_sys_clk_clk),                             //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_freertos_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (clocks_sys_clk_clk),                             //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_freertos_mm_interconnect_0_cmd_mux cmd_mux_006 (
		.clk                 (clocks_sys_clk_clk),                             //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_freertos_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clocks_sys_clk_clk),                             //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_freertos_mm_interconnect_0_cmd_demux_001 rsp_demux_001 (
		.clk                (clocks_sys_clk_clk),                             //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_freertos_mm_interconnect_0_cmd_demux_001 rsp_demux_002 (
		.clk                (clocks_sys_clk_clk),                             //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_freertos_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clocks_sys_clk_clk),                             //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_freertos_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clocks_sys_clk_clk),                             //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_freertos_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (clocks_sys_clk_clk),                             //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_freertos_mm_interconnect_0_rsp_demux rsp_demux_006 (
		.clk                (clocks_sys_clk_clk),                             //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_freertos_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clocks_sys_clk_clk),                             //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_freertos_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clocks_sys_clk_clk),                             //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_freertos_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
